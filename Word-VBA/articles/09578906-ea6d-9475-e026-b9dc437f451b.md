...
|:-----|:-----|:-----|:-----|
|Name|Required| **String**|Specifies the name of the building block entry. Corresponds to the  ** [Name](088e3d70-8fbb-2d3a-5b2a-09e7a2f79cc9.md)** property of the **BuildingBlock** object. If a building block entry with this name already exists, it will be overwritten.|
